  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'dark' : ''}`}>
      ...
      <header className={`sticky top-0 z-50 transition-all duration-300 ${
        isScrolled 
          ? 'h-16 bg-electric-navy/95 backdrop-blur-md shadow-2xl' 
          : 'h-32 bg-electric-navy border-b border-electric-blue/20'
      }`}>
        <div className="container mx-auto px-4 h-full">
          <div className="flex items-center justify-between h-full">
            ...
            <div className="flex items-center space-x-2 text-white">
              ...
              <span className={`font-light transition-all duration-300 ${isScrolled ? 'text-sm' : 'text-lg'}`}>
                ROCA SALES - RS
              </span>
            </div>
            ...
            <div className="flex flex-col items-center">
              <div className="flex items-center space-x-4 mb-2">
                <h1 className={`text-white font-medium transition-all duration-300 ${isScrolled ? 'text-xl' : 'text-3xl'}`}>
                  S&S ENERGIA
                </h1>
              </div>
              
              {/* Compact Navigation */}
              <div className={`flex items-center space-x-2 transition-all duration-300 ${isScrolled ? 'scale-90' : ''}`}>
                <Button 
                  variant="ghost" 
                  size="sm"
                  className="text-white text-xs bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-full px-3 py-1 border border-white/20"
                ...
                <div className={`bg-electric-gray rounded-full flex items-center justify-center transition-all duration-300 ${isScrolled ? 'w-8 h-8' : 'w-10 h-10'}`}>
                  <span className={`text-electric-navy font-bold transition-all duration-300 ${isScrolled ? 'text-xs' : 'text-sm'}`}>S&S</span>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div data-aos="fade-right" className="text-white space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button 
                    size="lg" 
                    className="bg-electric-orange hover:bg-electric-orange/90 text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                  >
                    SOLICITAR ORÇAMENTO
                  </Button>
                  <Button 
                    size="lg" 
                    variant="outline" 
                    className="border-white text-white hover:bg-white hover:text-electric-navy px-8 py-4 rounded-full backdrop-blur-sm"
                  >
                    NOSSOS SERVIÇOS
                  </Button>
                </div>
              ...
              <div data-aos="fade-left" className="grid grid-cols-2 gap-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/20">
                  <div className="text-4xl font-bold text-electric-orange mb-2">500+</div>
                  <div className="text-white">Projetos Concluídos</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/20">
                  <div className="text-4xl font-bold text-electric-orange mb-2">10+</div>
                  <div className="text-white">Anos de Experiência</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/20">
                  <div className="text-4xl font-bold text-electric-orange mb-2">24h</div>
      ...
      <section id="services" className="py-20 bg-gradient-to-br from-electric-navy to-electric-blue relative overflow-hidden">
        <div className="container mx-auto px-4">
            ...
            {Object.entries(servicesData).map(([key, service], index) => (
              <FollowerPointerCard key={key} title="Ver Detalhes do Serviço">
                ...
                >
                  ...
                  <div className="p-6">
                    <h3 className="text-lg font-bold text-electric-navy mb-3 group-hover:text-electric-orange transition-colors">
                      {service.title}
                    </h3>
                    <p className="text-gray-600 mb-4 text-sm line-clamp-2">{service.description}</p>
                    <p className="text-electric-orange font-bold mb-4">{service.price}</p>
                    <Button variant="outline" className="w-full rounded-full border-electric-orange text-electric-orange hover:bg-electric-orange hover:text-white">
                      VER DETALHES
                    </Button>
                  </div>
                </div>
      ...
      <section id="products" className="py-20 bg-gradient-to-r from-electric-blue to-electric-light-blue relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12" data-aos="fade-up">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">PRODUTOS EM DESTAQUE</h2>
            <div className="w-24 h-1 bg-electric-orange mx-auto mb-6"></div>
            <p className="text-white/80 text-xl max-w-2xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredProducts.map((product, index) => (
              <FollowerPointerCard key={index} title="Produto de Qualidade">
                <div 
                  data-aos="fade-up" 
                ...
                >
                  ...
                  <p className="text-electric-orange font-bold mb-4">{product.price}</p>
                  <Button className="w-full bg-electric-orange hover:bg-electric-orange/90 rounded-full">
                    SOLICITAR
                  </Button>
                </div>
              </FollowerPointerCard>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 bg-gradient-to-r from-electric-blue to-electric-light-blue relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12" data-aos="fade-up">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            {/* Contact Form */}
            <div data-aos="fade-up" className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <h3 className="text-2xl font-medium text-white mb-6">Solicite um Orçamento</h3>
              <form className="space-y-4">
                <input 
                  type="text" 
                  value={formData.name}
                  onChange={(e) => setFormData({...formData, name: e.target.value})}
                  className="w-full px-4 py-3 bg-white/20 backdrop-blur-sm border border-white/30 rounded-xl text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-white/50" 
                ...
                <StatefulButton 
                  ...
                  className="w-full py-3 text-lg bg-electric-orange hover:bg-electric-orange/90"
                >
                  ENVIAR SOLICITAÇÃO
                </StatefulButton>
              </form>
            ...
            {/* Map */}
            <div data-aos="fade-left" className="h-full min-h-[400px]">
              <Map />
            </div>
          </div>
        </div>
